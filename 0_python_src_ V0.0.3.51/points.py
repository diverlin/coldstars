...
class points():
      ...
      def addMainQuad(self):
          ...
          self.points = [(self.center_origin, self.center), (self.bottomLeft_origin, self.bottomLeft), (self.bottomRight_origin, self.bottomRight), (self.topRight_origin, self.topRight), (self.topLeft_origin, self.topLeft)]
