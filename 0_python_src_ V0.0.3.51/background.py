...
class distantNebulaStatic():
      ...
      def render(self, vx, vy):    
          drawTexturedRect(self.texture, [self.pos_x - vx*self.distance_rate, self.pos_y - vy*self.distance_rate, self.w, self.h], -1.0)
...
class distantNebulaRotated():
      ...
      def render(self, vx, vy):
          drawDynamic(self.texture, (self.pos_x - vx*self.distance_rate, self.pos_y - vy*self.distance_rate), self.angle, (-self.w/2, -self.h/2, self.w/2, self.h/2))
...
class effectNebula():
      def __init__(self):
         ...
         self.verticles_orig = [self.bottomLeft_orig, self.bottomRight_orig, self.topRight_orig, self.topLeft_orig]
      ...
      def render(self):
          ...
          drawQuadPer3DVertex(self.bottomLeft, self.bottomRight, self.topRight, self.topLeft)
