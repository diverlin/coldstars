...
class shipInternal():
      ...
      def skillManager(self, ob, lb, mx, my):
          button_w, button_h = self.increment_attack_buttonRect[2], self.increment_attack_buttonRect[3]
          
          ### ATTACK
          button_cursor_dist = lengthBetweenPoints((self.increment_attack_buttonRect[0] + button_w/2, self.increment_attack_buttonRect[1] + button_h/2), (mx, my))
          if button_cursor_dist < self.increment_attack_buttonRect[2]/2:
             if lb == True:
                ob.skill.incrementAttack()

          button_cursor_dist = lengthBetweenPoints((self.decrement_attack_buttonRect[0] + button_w/2, self.decrement_attack_buttonRect[1] + button_h/2), (mx, my))
          ...
          ### DEFENCE
          button_cursor_dist = lengthBetweenPoints((self.increment_defence_buttonRect[0] + button_w/2, self.increment_defence_buttonRect[1] + button_h/2), (mx, my))
          if button_cursor_dist < self.increment_defence_buttonRect[2]/2:
             if lb == True:
                ob.skill.incrementDefence()

          button_cursor_dist = lengthBetweenPoints((self.decrement_defence_buttonRect[0] + button_w/2, self.decrement_defence_buttonRect[1] + button_h/2), (mx, my))
          ...
          ### LEADER 
          button_cursor_dist = lengthBetweenPoints((self.increment_leader_buttonRect[0] + button_w/2, self.increment_leader_buttonRect[1] + button_h/2), (mx, my))
          if button_cursor_dist < self.increment_leader_buttonRect[2]/2:
             if lb == True:
                ob.skill.incrementLeader()

          button_cursor_dist = lengthBetweenPoints((self.decrement_leader_buttonRect[0] + button_w/2, self.decrement_leader_buttonRect[1] + button_h/2), (mx, my))
          ...
          ### TRADER 
          button_cursor_dist = lengthBetweenPoints((self.increment_trader_buttonRect[0] + button_w/2, self.increment_trader_buttonRect[1] + button_h/2), (mx, my))
          if button_cursor_dist < self.increment_leader_buttonRect[2]/2:
             if lb == True:
                ob.skill.incrementTrader()

          button_cursor_dist = lengthBetweenPoints((self.decrement_trader_buttonRect[0] + button_w/2, self.decrement_trader_buttonRect[1] + button_h/2), (mx, my))
          ...
          ### TECHNIC 
          button_cursor_dist = lengthBetweenPoints((self.increment_technic_buttonRect[0] + button_w/2, self.increment_technic_buttonRect[1] + button_h/2), (mx, my))
          if button_cursor_dist < self.increment_technic_buttonRect[2]/2:
             if lb == True:
                ob.skill.incrementTechnic()

          button_cursor_dist = lengthBetweenPoints((self.decrement_technic_buttonRect[0] + button_w/2, self.decrement_technic_buttonRect[1] + button_h/2), (mx, my))
          ...
          ### DIPLOMAT 
          button_cursor_dist = lengthBetweenPoints((self.increment_diplomat_buttonRect[0] + button_w/2, self.increment_diplomat_buttonRect[1] + button_h/2), (mx, my))
          if button_cursor_dist < self.increment_diplomat_buttonRect[2]/2:
             if lb == True:
                ob.skill.incrementDiplomat()

          button_cursor_dist = lengthBetweenPoints((self.decrement_diplomat_buttonRect[0] + button_w/2, self.decrement_diplomat_buttonRect[1] + button_h/2), (mx, my))
      ...
      def renderSkill(self):
          ...
          for i in xrange(0, self.skill.attack):  
          ...
          for i in xrange(0, self.skill.defence):
          ...
          for i in xrange(0, self.skill.leader):
          ...
          for i in xrange(0, self.skill.trader):
          ...
          for i in xrange(0, self.skill.technic):
          ...
          for i in xrange(0, self.skill.diplomat):
          ...
          for slot in self.korpus.total_slot_list:
              ...
              if slot_cursor_dist < slot.rect[2]/2:
                 ...
                 ############## put item into slot ##################
                      ...
                      if self.taken_item.type == MODULE_ID and slot.item.type != MODULE_ID:
