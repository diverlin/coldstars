...
class Store():
    ...
    def createSlots(self):
        ...
        while row_act <= row:
              clm_act = 1
              while clm_act <= clm:
                    slot  = SlotForStore(slot_tex_ID, (x0 + clm_act * 1.1 * self.slot_w, y0 + row_act * 1.1 * self.slot_h),  (self.slot_w, self.slot_h), STORE_SLOT_ID, None)
                    slot.item = None
