...
class textureManager():
      ...
      def returnRandomFaceTexObByRaceId(self, race_id):
          if race_id == RACE_0_ID:
             texOb = self.race0Face_texOb_list[randint(0, len(self.race0Face_texOb_list)-1)]
          elif race_id == RACE_1_ID:
             texOb = self.race1Face_texOb_list[randint(0, len(self.race1Face_texOb_list)-1)]
          elif race_id == RACE_2_ID:
             texOb = self.race2Face_texOb_list[randint(0, len(self.race2Face_texOb_list)-1)]
          elif race_id == RACE_3_ID:
             texOb = self.race3Face_texOb_list[randint(0, len(self.race3Face_texOb_list)-1)]
          elif race_id == RACE_4_ID:
             texOb = self.race4Face_texOb_list[randint(0, len(self.race4Face_texOb_list)-1)]
          elif race_id == RACE_6_ID:
             texOb = self.race6Face_texOb_list[randint(0, len(self.race6Face_texOb_list)-1)]
          elif race_id == RACE_7_ID:
             texOb = self.race7Face_texOb_list[randint(0, len(self.race7Face_texOb_list)-1)]
          elif race_id == None:
             texOb = None
          return texOb
...
class textureOb():
      def __init__(self, type_id, path, use_alpha = True, arg = [], slice_w = None, slice_h = None):
          self.path      = path
          ...
          elif self.type_id == ROCKET_ITEM_TEXTURE_ID or self.type_id == TORPED_ITEM_TEXTURE_ID:
             self.loadToVRAM()  # remove
      ...
      def loadSlicedToVRAM(self):
          if self.loaded == False:
             self.texture, (self.w, self.h) = uploadSlicedTextures(self.path, (self.slice_w, self.slice_h))
             self.shared = False
             self.loaded = True
          else:
             self.shared = True
...
def uploadSlicedTextures(filename, (frame_width, frame_height)):
    ...
    for i in xrange(int(master_height/frame_height)):
        for j in xrange(int(master_width/frame_width)):
            surf = master_surface.subsurface((j*frame_width, i*frame_height, frame_width, frame_height))
