...
ENERGYBLOCK_ITEM_TEXTURE_ID = TYPE_ID_GENERATOR.returnNextID('ENERGYBLOCK_ITEM_TEXTURE_ID') 
...
ALL_EQUIPMENT_ID_list = [LAZER_ID, ROCKET_ID, ENERGYBLOCK_ID, GRAPPLE_ID, RADAR_ID, DRIVE_ID, PROTECTOR_ID, BAK_ID, DROID_ID, SCANER_ID]
...
PLANET_SURFACE_list = [PLANET_EARTH_SURFACE_ID, PLANET_WATER_SURFACE_ID, PLANET_LAVA_SURFACE_ID, PLANET_ICE_SURFACE_ID, PLANET_GAS_SURFACE_ID]
...
RACES_LIST = [RACE_0_ID, RACE_1_ID, RACE_2_ID, RACE_3_ID, RACE_4_ID, RACE_6_ID, RACE_7_ID]
