...
class KeyEventsInSpace():
     ...
     def update(self):
        ...
        self.my = VIEW_HEIGHT - self.my  # change direction of the Y axis (pygame and opengl Y axis are opposite)
              ...
              return self.RUNNING
                ...
                if evt.key == pygame.K_LEFT:
                   ...
                   self.turn_end = 0
                     ...
                     if self.slot_1_SELECTED == True and self.slot_2_SELECTED == True and self.slot_3_SELECTED == True and self.slot_4_SELECTED == True and self.slot_5_SELECTED == True:
                        self.slot_1_SELECTED = False
                        self.slot_2_SELECTED = False
                        self.slot_3_SELECTED = False
                        self.slot_4_SELECTED = False
     ...
     def readControlKeys(self):
         self.update()
         return self.RUNNING, self.vpCoordinate_x, self.vpCoordinate_y, self.turn_end, self.show_ships_info_FLAG, self.show_planet_info_FLAG, self.show_planet_orbit_FLAG, self.show_RADAR, self.garpun_SELECTED, self.slot_1_SELECTED, self.slot_2_SELECTED, self.slot_3_SELECTED, self.slot_4_SELECTED, self.slot_5_SELECTED, self.mouse_left_button_click, self.mouse_right_button_click, self.mx, self.my
