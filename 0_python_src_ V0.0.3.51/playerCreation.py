...
player = PlayerShip(None, 'plr', RACE_0_ID, TEXTURE_MANAGER.returnRandomFaceTexObByRaceId(RACE_0_ID), WARRIOR_ID)
player.item_list = [bakModule1, droidModule1, scanerModule1, rocket1, rocket2, lazer1, lazer2, lazer3, generator1, freezer1, grapple1, radar1, drive1, protector1, bak1, droid1, scaner1, bomb1, bomb2, bomb3]
