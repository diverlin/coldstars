...
class interfaceInSpace():
      def __init__(self):
          ...
          self.galaxy_button_rect = pygame.Rect((VIEW_WIDTH - (INTERFACE_ICON_SIZE + 5), VIEW_HEIGHT - (INTERFACE_ICON_SIZE + 5)), (INTERFACE_ICON_SIZE,  INTERFACE_ICON_SIZE))
      ...
      def mouseInteraction(self, (mx, my), lb, (vpCoordinate_x, vpCoordinate_y)):
          ...
          if CURSOR_INTERSECT_OBJECT != True:
             ss_cursor_dist = lengthBetweenPoints((self.galaxy_button_rect.centerx + vpCoordinate_x, self.galaxy_button_rect.centery + vpCoordinate_y), (mxvp, myvp))
