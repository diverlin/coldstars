...
class CommonForItems(CommonInstance):
      def __init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate):
          self.item_texOb = item_texOb
          CommonInstance.__init__(self, self.item_texOb.texture, (self.item_texOb.w, self.item_texOb.h))
      ...
      def renderFrame(self, slot_rect):
          ...
          for m in self.modules_list:
              drawTexturedRect(m.texture_ID, [slot_rect[0] + (1.1 * INSERTED_MODULE_SIZE) * i, slot_rect[1], INSERTED_MODULE_SIZE, INSERTED_MODULE_SIZE], -1)
              i += 1
      ...
      def renderFrames(self, slot_rect):
          ...
          if self.subtype == ROCKET_ID or self.subtype == TORPED_ID:
             renderSimpleText((slot_rect[0], slot_rect[1]), str(self.ammo_max) + '/' + str(self.ammo))
...
class radarItem(CommonForItems):
      def __init__(self, race, item_texOb, radius_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
      ...
      def countPrice(self):
          ...
          effectiveness_rate  = RADAR_RADIUS_WEIGHT * radius_rate +  RADAR_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def updateInfo(self):
          self.info = ['RADAR', self.returnRadiusStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def radarGenerator(race_id, revision_id = -1):
    ...
    radar = radarItem(race_id, item_texOb, radius_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class driveItem(CommonForItems):
      def __init__(self, race, item_texOb, speed_orig, hyper_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
          ...
          self.pTexture   = TEXTURE_MANAGER.returnParticleTexObBy_ColorID(self.item_texOb.color_id)
          self.pNum       = 5
          self.pSize      = 6
          self.pVelocity  = 1.2
          self.pAlphaInit = 1.0
      ...
      def countPrice(self):
          ...
          effectiveness_rate = DRIVE_SPEED_WEIGHT * speed_rate + DRIVE_HYPER_WEIGHT * hyper_rate + DRIVE_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def updateInfo(self):
          self.info = ['DRIVE', self.returnSpeedStr(), self.returnHyperStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def driveGenerator(race_id, revision_id = -1):
    ...
    drive = driveItem(race_id, item_texOb, speed_orig, hyper_orig, modules_num_max, mass, condition_max, deterioration_rate)
    return drive
...
class bakItem(CommonForItems):
      def __init__(self, race, item_texOb, fuel_max_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
      ...
      def countPrice(self):
          ...
          effectiveness_rate = BAK_FUEL_WEIGHT * fuel_rate + BAK_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def returnFuelStr(self):
          if self.fuel_max_add == 0:
             ...
             return 'fuel:' + str(self.fuel_max_orig) + '+' + str(self.fuel_max_add) + '/' + str(self.fuel)

      def updateInfo(self):
          self.info = ['BAK', self.returnFuelStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def bakGenerator(race_id, revision_id = -1):
    ...
    bak = bakItem(race_id, item_texOb, fuel_max_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class energyBlockItem(CommonForItems):
      def __init__(self, race, item_texOb, energy_max_orig, restoration_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
      ...
      def countPrice(self):
          ...
          effectiveness_rate = GENERATOR_ENERGY_WEIGHT * energy_rate + GENERATOR_RESTORATION_WEIGHT * restoration_rate + GENERATOR_MODULES_NUM * modules_num_rate
      ...
      def returnEnergyStr(self):
          if self.energy_max_add == 0:
             ...
             return 'energy:' + str(self.energy_max_orig) + '+' + str(self.energy_max_add) + '/' + str(self.energy)

      def returnRestorationStr(self):
          if self.restoration_add == 0:
             return 'restoration:' + str(self.restoration_orig)
          else:
             return 'restoration:' + str(self.restoration_orig) + '+' + str(self.restoration_add)

      def updateInfo(self):
          self.info = ['energyBlock', self.returnEnergyStr(), self.returnRestorationStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]


def energyBlockGenerator(race_id, revision_id = -1):
    tech_rate = returnRaceTechRate(race_id)  

    item_texOb = TEXTURE_MANAGER.returnItemTexOb(ENERGYBLOCK_ITEM_TEXTURE_ID, revision_id)
    ...
    condition_max = int(randint(GENERATOR_CONDITION_MIN, GENERATOR_CONDITION_MAX) * tech_rate)

    deterioration_rate = 1

    energyBlock = energyBlockItem(race_id, item_texOb, energy_max_orig, restoration_orig, modules_num_max, mass, condition_max, deterioration_rate)

    return energyBlock


class protectorItem(CommonForItems):
      def __init__(self, race, item_texOb, protection_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate )
      ...
      def countPrice(self):
          ...
          effectiveness_rate = PROTECTOR_PROTECTION_WEIGHT * protection_rate + PROTECTOR_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def returnProtectionStr(self):
          if self.protection_add == 0:
             ...
             return 'protection:' + str(self.protection_orig) + '+' + str(self.protection_add)

      def updateInfo(self):
          self.info = ['PROTECTOR', self.returnProtectionStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def protectorGenerator(race_id, revision_id = -1):
    ...
    condition_max = int(randint(PROTECTOR_CONDITION_MIN, PROTECTOR_CONDITION_MAX) * tech_rate)
    deterioration_rate = 1

    protector = protectorItem(race_id, item_texOb, protection_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class droidItem(CommonForItems):
      def __init__(self, race, item_texOb, repair_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate )
      ...
      def countPrice(self):
          ...
          effectiveness_rate = DROID_REPAIR_WEIGHT * repair_rate + DROID_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def updateInfo(self):
          self.info = ['DROID', self.returnRepairStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def droidGenerator(race_id, revision_id = -1):
    ...
    droid = droidItem(race_id, item_texOb, repair_orig, modules_num_max, mass, condition_max, deterioration_rate)

    return droid


class freezerItem(CommonForItems):
      def __init__(self, race, item_texOb, freeze_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
      ...
      def countPrice(self):
          ...
          effectiveness_rate = FREEZER_FREEZE_WEIGHT * freeze_rate + FREEZER_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def updateInfo(self):
          self.info = ['FREEZER', self.returnFreezeStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def freezerGenerator(race_id, revision_id = -1):
    ...
    condition_max = int(randint(FREEZER_CONDITION_MIN, FREEZER_CONDITION_MAX) * tech_rate)

    deterioration_rate = 1

    freezer = freezerItem(race_id, item_texOb, freeze_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class scanerItem(CommonForItems):
      def __init__(self, race, item_texOb, scan_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
      ...
      def countPrice(self):
          ...
          effectiveness_rate = SCANER_SCAN_WEIGHT * scan_rate + SCANER_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def updateInfo(self):
          self.info = ['SCANER', self.returnScanStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def scanerGenerator(race_id, revision_id = -1):
    ...
    scaner = scanerItem(race_id, item_texOb, scan_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class grappleItem(CommonForItems):
      def __init__(self, race, item_texOb, strength_orig, radius_orig, speed_orig, maxNumItem_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
      ...
      def countPrice(self):
          ...
          effectiveness_rate = GRAPPLE_STRENGTH_WEIGHT * strength_rate + GRAPPLE_RADIUS_WEIGHT * radius_rate + GRAPPLE_SPEED_WEIGHT * speed_rate + GRAPPLE_MAXNUMITEM_WEIGHT * maxNumItem_rate + GRAPPLE_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def returnMaxNumItemStr(self):
          if self.maxNumItem_add == 0:
             ...
             return 'maxNumItem:' + str(self.maxNumItem_orig) + '+' + str(self.maxNumItem_add)

      def updateInfo(self):
          self.info = ['GRAPPLE', self.returnStrengthStr(), self.returnRadiusStr(), self.returnSpeedStr(), self.returnMaxNumItemStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price:' + str(self.price)]
...
def grappleGenerator(race_id, revision_id = -1):
    ...
    condition_max = int(randint(GRAPPLE_CONDITION_MIN, GRAPPLE_CONDITION_MAX) * tech_rate)

    deterioration_rate = 1

    grapple = grappleItem(race_id, item_texOb, strength_orig, radius_orig, speed_orig, maxNumItem_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class LazerWeapon(CommonForItems):
      def __init__(self, race, item_texOb, damage_orig, radius_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
          ...
          self.lazerEffect_texOb   = TEXTURE_MANAGER.returnLazerEffectTexObBy_RevisionID_and_ColorID(self.item_texOb.revision_id, self.item_texOb.color_id)
          self.particle_texOb = TEXTURE_MANAGER.returnParticleTexObBy_ColorID(self.item_texOb.color_id)

          self.l_tex, (self.l_w, self.l_h) = self.lazerEffect_texOb.texture, (self.lazerEffect_texOb.w, self.lazerEffect_texOb.h)
      ...
      def countPrice(self):
          ...
          effectiveness_rate = LAZER_DAMAGE_WEIGHT * damage_rate + LAZER_RADIUS_WEIGHT * radius_rate + LAZER_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def updateInfo(self):
          self.info = ['LAZER', self.returnDamageStr(), self.returnRadiusStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price: ' + str(self.price)]
...
def lazerGenerator(race_id, revision_id = -1):
    ...
    lazer = LazerWeapon(race_id, item_texOb, damage_orig, radius_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class RocketWeapon(CommonForItems):
      ...
      def __init__(self, race, item_texOb, ammo_max_orig, damage_orig, radius_orig, modules_num_max, mass, condition_max, deterioration_rate):
          CommonForItems.__init__(self, race, item_texOb, modules_num_max, mass, condition_max, deterioration_rate)
          ...
          self.bullet_texOb = TEXTURE_MANAGER.rocketBullet_texOb_list[randint(0, len(TEXTURE_MANAGER.rocketBullet_texOb_list) - 1)]
      ...
      def countPrice(self):
          ...
          effectiveness_rate = ROCKET_AMMO_WEIGHT * ammo_rate + ROCKET_DAMAGE_WEIGHT * damage_rate + ROCKET_RADIUS_WEIGHT * radius_rate + ROCKET_MODULES_NUM_WEIGHT * modules_num_rate
      ...
      def returnAmmoStr(self):
          if self.ammo_max_add == 0:
             ...
             return 'ammo:' + str(self.ammo_max_orig) + '+' + str(self.ammo_max_add) + '/' + str(self.ammo)
      ...
      def updateInfo(self):
          self.info = ['ROCKET', self.returnAmmoStr(), self.returnDamageStr(), self.returnRadiusStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price: ' + str(self.price)]
      ...
      def Fire(self):
          ...
          r1 = rocketBulletInstance(self.bullet_texOb, l_owner, l_target, self.damage,  self.bullet_size, self.bullet_armor, self.bullet_speed_init, self.bullet_speed_max, self.bullet_d_speed, self.bullet_live_time, self.bullet_angular_speed)
...
def rocketGenerator(race_id, revision_id = -1):
    ...
    rocket = RocketWeapon(race_id, item_texOb, ammo_max_orig, damage_orig, radius_orig, modules_num_max, mass, condition_max, deterioration_rate)
...
class torpedWeapon(CommonForItems):
      ...
      def __init__(self, race, item_texOb, ammo_max_orig, damage_orig, radius_orig, modules_num_max, mass, condition_max, deterioration_rate):
          ...
          self.bullet_texOb = TEXTURE_MANAGER.torpedBullet_texOb_list[randint(0, len(TEXTURE_MANAGER.torpedBullet_texOb_list) - 1)]
          self.bullet_size              = returnObjectSize(self.bullet_texOb.w, self.bullet_texOb.h) 
      ...
      def updateInfo(self):
          self.info = ['Torpedo', self.returnAmmoStr(), self.returnDamageStr(), self.returnRadiusStr(), 'modules:' + str(self.modules_num_max), 'condition:' + str(self.condition) + '/' + str(self.condition_max), 'mass:' + str(self.mass), 'price: ' + str(self.price)]
      ...
      def Fire(self):
          ...
          t = rocketBulletInstance(self.bullet_texOb, l_owner, l_target, self.damage,  self.bullet_size, self.bullet_armor, self.bullet_speed_init, self.bullet_speed_max, self.bullet_d_speed, self.bullet_live_time, self.bullet_angular_speed)
...
def torpedGenerator(race_id, revision_id = -1):
    ...
    torped = torpedWeapon(race_id, item_texOb, ammo_max_orig, damage_orig, radius_orig, modules_num_max, mass, condition_max, deterioration_rate)
