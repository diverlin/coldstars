...
class Angar():
    ...
    def createSlots(self):
        slot = SlotForAngar(self.angar_slot_tex, (VIEW_WIDTH/2 - self.slot_w, VIEW_HEIGHT/2 - self.slot_h),  (self.slot_w, self.slot_h), ANGAR_SLOT_ID, None)
        slot.item = None
        self.slot_list.append(slot)

        slot = SlotForAngar(self.angar_slot_tex, (VIEW_WIDTH/2 - self.slot_w + 150, VIEW_HEIGHT/2 - self.slot_h),  (self.slot_w, self.slot_h), ANGAR_SLOT_ID, None)
        slot.item = None
        self.slot_list.append(slot)
        ...
        slot = SlotForAngar(self.angar_slot_tex, (VIEW_WIDTH/2 - self.slot_w, VIEW_HEIGHT/2 - self.slot_h + 150),  (self.slot_w, self.slot_h), ANGAR_SLOT_ID, None)
        slot.item = None
        self.slot_list.append(slot)
    ...
    def createButtons(self):
        ...
        self.repair_button_rect = pygame.Rect((VIEW_WIDTH - (INTERFACE_ICON_SIZE + 5), 1 * (INTERFACE_ICON_SIZE + 5)), (INTERFACE_ICON_SIZE,  INTERFACE_ICON_SIZE))
        self.fuel_button_rect   = pygame.Rect((VIEW_WIDTH - (INTERFACE_ICON_SIZE + 5), 2 * (INTERFACE_ICON_SIZE + 5)), (INTERFACE_ICON_SIZE,  INTERFACE_ICON_SIZE))
        self.launch_button_rect = pygame.Rect((VIEW_WIDTH - (INTERFACE_ICON_SIZE + 5), 3 * (INTERFACE_ICON_SIZE + 5)), (INTERFACE_ICON_SIZE,  INTERFACE_ICON_SIZE))
    ...
    def manageMouse(self, player, (mx, my), lb):
        ...
        if CURSOR_INTERSECT_OBJECT == False:
           repairbutton_cursor_dist = lengthBetweenPoints((self.repair_button_rect.centerx, self.repair_button_rect.centery), (mx, my))
        ...
        if CURSOR_INTERSECT_OBJECT == False:
           fuelbutton_cursor_dist = lengthBetweenPoints((self.fuel_button_rect.centerx, self.fuel_button_rect.centery), (mx, my))
        ...
        if CURSOR_INTERSECT_OBJECT == False:
           launchbutton_cursor_dist = lengthBetweenPoints((self.launch_button_rect.centerx, self.launch_button_rect.centery), (mx, my))
