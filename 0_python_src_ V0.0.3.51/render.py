...
def drawDynamic(texture_ID, (x, y), angle, (minus_half_w, minus_half_h, plus_half_w, plus_half_h)):
    ...
    glTexCoord3f(0, 0, 0); glVertex3f(minus_half_w, minus_half_h, -2)
    glTexCoord3f(1, 0, 0); glVertex3f(plus_half_w,  minus_half_h, -2)
    glTexCoord3f(1, 1, 0); glVertex3f(plus_half_w,  plus_half_h,  -2)
    glTexCoord3f(0, 1, 0); glVertex3f(minus_half_w, plus_half_h,  -2)
...
def drawQuadPer2DVertex(bottomLeft, bottomRight, topRight, topLeft, z):
    ...
    glTexCoord3f(0, 0, 0); glVertex3f(bottomLeft[0],  bottomLeft[1]  , z)
    glTexCoord3f(1, 0, 0); glVertex3f(bottomRight[0], bottomRight[1] , z)
    glTexCoord3f(1, 1, 0); glVertex3f(topRight[0],    topRight[1]    , z)
    glTexCoord3f(0, 1, 0); glVertex3f(topLeft[0],     topLeft[1]     , z)
...
def drawQuadPer3DVertex(bottomLeft, bottomRight, topRight, topLeft):
    ...
    glTexCoord3f(0, 0, 0); glVertex3f(bottomLeft[0],  bottomLeft[1]  , bottomLeft[2])
    glTexCoord3f(1, 0, 0); glVertex3f(bottomRight[0], bottomRight[1] , bottomRight[2])
    glTexCoord3f(1, 1, 0); glVertex3f(topRight[0],    topRight[1]    , topRight[2])
    glTexCoord3f(0, 1, 0); glVertex3f(topLeft[0],     topLeft[1]     , topLeft[2])
...
def drawFullScreenQuad(w, h, z_pos):  
    ...
    glTexCoord3f(0, 0, 0); glVertex3f(0, 0, z_pos)
    glTexCoord3f(1, 0, 0); glVertex3f(w, 0, z_pos)
    glTexCoord3f(1, 1, 0); glVertex3f(w, h, z_pos)
    glTexCoord3f(0, 1, 0); glVertex3f(0, h, z_pos)
...
def drawRect(rect, z_pos):
    ...
    glTexCoord3f(0, 0, 0); glVertex3f(rect[0],           rect[1]            , z_pos)
    glTexCoord3f(1, 0, 0); glVertex3f(rect[0] + rect[2], rect[1]            , z_pos)
    glTexCoord3f(1, 1, 0); glVertex3f(rect[0] + rect[2], rect[1] + rect[3]  , z_pos)
    glTexCoord3f(0, 1, 0); glVertex3f(rect[0],           rect[1] + rect[3]  , z_pos)
...
def drawLine(texture, (start_pos_x, start_pos_y, z_pos), len, angle, half_h):
    ...
    glTexCoord3f(0, 0, 0); glVertex3f(0,   -half_h, z_pos)
    glTexCoord3f(1, 0, 0); glVertex3f(len, -half_h, z_pos)
    glTexCoord3f(1, 1, 0); glVertex3f(len,  half_h, z_pos)
    glTexCoord3f(0, 1, 0); glVertex3f(0,    half_h, z_pos)
...
def drawVpCoord((vpCoordinate_x, vpCoordinate_y)):
    glLoadIdentity()
    FPS_FONT.glPrint(VIEW_WIDTH - 300, VIEW_HEIGHT - TEXT_OFFSET, "%i:%i"%(vpCoordinate_x, vpCoordinate_y))





def GlListCompileDirection(texture_ID, list_x, list_y, list_len, step, pointer_size = DOT_SIZE):
