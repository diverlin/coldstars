...
def rocketModuleGenerator():
    ...
    rocket_module.damage_add = randint(ROCKET_MODULE_DAMAGE_MIN, ROCKET_MODULE_DAMAGE_MAX)
    rocket_module.radius_add = randint(ROCKET_MODULE_RADIUS_MIN, ROCKET_MODULE_RADIUS_MAX)
...
def generatorModuleGenerator():
    ...
    generator_module.energy_max_add = randint(GENERATOR_MODULE_ENERGY_MIN, GENERATOR_MODULE_ENERGY_MAX)
    generator_module.restoration_add = randint(GENERATOR_MODULE_RESTORATION_MIN, GENERATOR_MODULE_RESTORATION_MAX)
...
class freezerModule(CommonForModules):
      ...
      def updateInfo(self):
          self.info = ['Freezer Module', 'freezer +' + str(self.freeze_add), 'mass:' + str(self.mass)]

def freezerModuleGenerator():
    freezer_module = freezerModule((module_tex, (module_w, module_h)))
    freezer_module.freeze_add = randint(FREZZER_MODULE_FREEZE_MIN, FREZZER_MODULE_FREEZE_MAX)
...
def grappleModuleGenerator():
    ...
    grapple_module.strength_add = randint(GRAPPLE_MODULE_STRENGTH_MIN, GRAPPLE_MODULE_STRENGTH_MAX)
    grapple_module.radius_add = randint(GRAPPLE_MODULE_RADIUS_MIN, GRAPPLE_MODULE_RADIUS_MAX)
    grapple_module.speed_add = randint(GRAPPLE_MODULE_SPEED_MIN, GRAPPLE_MODULE_SPEED_MAX)
    grapple_module.maxNumItem_add = randint(GRAPPLE_MODULE_MAXNUMITEM_MIN, GRAPPLE_MODULE_MAXNUMITEM_MAX)
...
class radarModule(CommonForModules):
      ...
      def updateInfo(self):
          self.info = ['Radar Module', 'radius +' + str(self.radius_add), 'mass:' + str(self.mass)]
...
class protectorModule(CommonForModules):
      ...
      def updateInfo(self):
          self.info = ['Protector Module', 'protection +' + str(self.protection_add), 'mass:' + str(self.mass)]

def protectorModuleGenerator():
    protector_module = protectorModule((module_tex, (module_w, module_h)))
    protector_module.protection_add = randint(PROTECTOR_MODULE_PROTECTION_MIN, PROTECTOR_MODULE_PROTECTION_MAX)
...
class bakModule(CommonForModules):
      ...
      def updateInfo(self):
          self.info = ['Bak Module', 'fuel +' + str(self.fuel_max_add), 'mass:' + str(self.mass)]
...
class droidModule(CommonForModules):
      ...
      def updateInfo(self):
          self.info = ['Droid Module', 'repair +' + str(self.repair_add), 'mass:' + str(self.mass)]
...
class scanerModule(CommonForModules):
      ...
      def updateInfo(self):
          self.info = ['Scaner Module', 'scan +' + str(self.scan_add), 'mass:' + str(self.mass)]
