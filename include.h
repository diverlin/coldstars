...
#include "src/items/commonforitems.h"
class TurrelInstance;
class WeaponSlot;
#include "src/items/rocketItem.h"
#include "src/items/lazerItem.h"
#include "src/items/radarItem.h"
#include "src/items/driveItem.h"
#include "src/items/bakItem.h"
#include "src/items/energizerItem.h"
#include "src/items/protectorItem.h"
#include "src/items/droidItem.h"
#include "src/items/freezerItem.h"
#include "src/items/scanerItem.h"
#include "src/items/grappleItem.h"
...
#include "src/items/commonforitems.cpp"
#include "src/items/rocketItem.cpp"
#include "src/items/lazerItem.cpp"
#include "src/items/radarItem.cpp"
#include "src/items/driveItem.cpp"
#include "src/items/bakItem.cpp"
#include "src/items/energizerItem.cpp"
#include "src/items/protectorItem.cpp"
#include "src/items/droidItem.cpp"
#include "src/items/freezerItem.cpp"
#include "src/items/scanerItem.cpp"
#include "src/items/grappleItem.cpp"
