...
enum ENTITY_TYPE
{
	...
	STARBASE_ID, SATELLITE_ID, MILITARY_ID,
...
{ 
	...
	STARBASE_TEXTURE_ID, SATELLITE_TEXTURE_ID, SHIP_TEXTURE_ID, STAR_TEXTURE_ID, NEBULA_TEXTURE_ID, PLANET_TEXTURE_ID, ATMOSPHERE_TEXTURE_ID, LAND_BG_TEXTURE_ID,
