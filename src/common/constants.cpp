...
// TEXTURES ID
const int SLOT_TEXTURE_ID       = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int TURREL_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId(); 
//const int MODULE_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId(); 

const int SPUTNIK_TEXTURE_ID       = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int SHIP_TEXTURE_ID          = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int STAR_TEXTURE_ID          = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int NEBULA_TEXTURE_ID        = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int PLANET_TEXTURE_ID        = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int ATMOSPHERE_TEXTURE_ID    = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int LAND_BG_TEXTURE_ID       = g_TEXTURE_ID_GENERATOR.getNextId(); 

const int ANGAR_BG_TEXTURE_ID      = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int STORE_BG_TEXTURE_ID      = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int SHOP_BG_TEXTURE_ID       = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int GOVERMENT_BG_TEXTURE_ID  = g_TEXTURE_ID_GENERATOR.getNextId();  

const int PARTICLE_TEXTURE_ID      = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int DISTANTSTAR_TEXTURE_ID   = g_TEXTURE_ID_GENERATOR.getNextId();  
const int LAZER_EFFECT_TEXTURE_ID  = g_TEXTURE_ID_GENERATOR.getNextId();  
const int SHIELD_EFFECT_TEXTURE_ID = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int FACE_TEXTURE_ID          = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int ASTEROID_TEXTURE_ID      = g_TEXTURE_ID_GENERATOR.getNextId();  
const int MINERAL_TEXTURE_ID       = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int CONTAINER_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int BOMB_TEXTURE_ID          = g_TEXTURE_ID_GENERATOR.getNextId();  
const int BLACKHOLE_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId();  


//// TEXTURES FOR ITEMS
const int DRIVE_ITEM_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int LAZER_ITEM_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int ROCKET_ITEM_TEXTURE_ID    = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int TORPED_ITEM_TEXTURE_ID    = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int PROTECTOR_ITEM_TEXTURE_ID = g_TEXTURE_ID_GENERATOR.getNextId();  
const int DROID_ITEM_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int GRAPPLE_ITEM_TEXTURE_ID   = g_TEXTURE_ID_GENERATOR.getNextId();  
const int BAK_ITEM_TEXTURE_ID       = g_TEXTURE_ID_GENERATOR.getNextId();  
const int ENERGYBLOCK_ITEM_TEXTURE_ID = g_TEXTURE_ID_GENERATOR.getNextId();  
const int FREEZER_ITEM_TEXTURE_ID   = g_TEXTURE_ID_GENERATOR.getNextId();  
const int RADAR_ITEM_TEXTURE_ID     = g_TEXTURE_ID_GENERATOR.getNextId(); 
const int SCANER_ITEM_TEXTURE_ID    = g_TEXTURE_ID_GENERATOR.getNextId();  

//// TEXTURES FOR BULLET
const int ROCKET_BULLET_TEXTURE_ID = g_TEXTURE_ID_GENERATOR.getNextId();  
const int TORPED_BULLET_TEXTURE_ID = g_TEXTURE_ID_GENERATOR.getNextId(); 
/////////////////////////////////////
