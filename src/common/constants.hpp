...
namespace ENTITY 
{
	enum TYPE
	{
		SHIP, NPC, ROCKET, SPACESTATION, SATELLITE, MINERAL, CONTAINER, STARSYSTEM, STAR, ASTEROID, PLANET, BLACKHOLE, BOMB
	};
};
...
namespace NAVIGATOR_ACTION
{
	enum TYPE
	{
		NONE, DOCKING, COLLECTING, KEEP_CLOSE, KEEP_MIDDLE, KEEP_FAR 
	};
}
...
namespace SLOT
{
	...
	{
		SLOT, 
		CARGO, GATE, WEAPON, DRIVE, RADAR, BAK, ENERGIZER, PROTECTOR, DROID, FREEZER, GRAPPLE, SCANER, 
	};
}
...
namespace EQUIPMENT
{
	...
	{
		EQUIPMENT, 
		LAZER, ROCKET, DRIVE, RADAR, BAK, ENERGIZER, PROTECTOR, DROID, FREEZER, GRAPPLE, SCANER
	};	
}
...
namespace QUEST
{
	enum TYPE
	{
		LIBERATION_STARSYSTEM, DESTROY_SHIP	
	};
}
...
enum ENTITY_TYPE
{	
	GOODS_ID, PLAYER_ID, KOSMOPORT_ID, LAND_ID, 
	MILITARY_ID,
...
{ 
	...
	SPACESTATION_TEXTURE_ID, SATELLITE_TEXTURE_ID, SHIP_TEXTURE_ID, STAR_TEXTURE_ID, NEBULA_TEXTURE_ID, PLANET_TEXTURE_ID, ATMOSPHERE_TEXTURE_ID, LAND_BG_TEXTURE_ID,
