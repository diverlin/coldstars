...
void UserInputManagerInSpace::UpdateInSpace(Star* star)
{
    Reset();
    
    ManageInputsInSpace(star);
    ManageRealTimeInputsInSpace(star);
    MouseButtonPressed(star);
    ScrollCamera(star);
}


void UserInputManagerInSpace::ManageInputsInSpace(Star* star)
{  
    ...
    for (const auto & key_code : UserInput::Instance().m_KeyboardCodesPressed_vec)   
    {
        ...
        {    
            case sf::Keyboard::K:
            {        
                star->ChangeLightThreshold(0.004);
                break;
            }
            ...
            case sf::Keyboard::I:
            {
                star->ChangeOffseTextureSpeed(0.00001);
                break;
            }
            case sf::Keyboard::O:
            {
...
void UserInputManagerInSpace::MouseButtonPressed(Star* star)
{
...
void UserInputManagerInSpace::ManageRealTimeInputsInSpace(Star* star)
{                      
...
void UserInputManagerInSpace::ScrollCamera(Star* star)
{
