...
//RocketModule* OtsecSlot :: returnEquipedItem()
//{
    
//}

//LazerModule* OtsecSlot :: returnEquipedItem()
//{
...
int OtsecSlot :: returnEquipedItemMass()
{  
...
int OtsecSlot :: returnEquipedItemPrice()
{  
    if (item_subtype_id == LAZER_ITEM_ID)  
