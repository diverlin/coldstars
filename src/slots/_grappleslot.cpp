...
#include "grappleslot.h"


GrappleSlot :: GrappleSlot()
{}

GrappleSlot :: GrappleSlot(Ship* _pTo_ship, TextureOb* _pTo_texOb, int _pos_x, int _pos_y)
{
     CommonForSlot_init(_pTo_ship, _pTo_texOb, _pos_x, _pos_y);
     type_id = GRAPPLE_SLOT_ID;
}

void GrappleSlot :: insertGrappleItem(GrappleItem* pTo_item)
{
...
void GrappleSlot :: removeGrappleItem()
{
    item_subtype_id = -1;
...
void GrappleSlot :: renderFrame(GLuint flash_tex)
{
...
void GrappleSlot :: renderFrames(GLuint flash_tex)
{
...
void GrappleSlot :: renderItemInfo()
{
    if (is_EQUIPED == true)
