...
#include "freezerslot.h"



FreezerSlot :: FreezerSlot()
{}

FreezerSlot :: FreezerSlot(Ship* _pTo_ship, TextureOb* _pTo_texOb, int _pos_x, int _pos_y)
{
     CommonForSlot_init(_pTo_ship, _pTo_texOb, _pos_x, _pos_y);
     type_id = FREEZER_SLOT_ID;
}

void FreezerSlot :: insertFreezerItem(FreezerItem* pTo_item)
{
...
void FreezerSlot :: removeFreezerItem()
{
    item_subtype_id = -1;    
...
void FreezerSlot :: renderFrame(GLuint flash_tex)
{
...
void FreezerSlot :: renderFrames(GLuint flash_tex)
{
...
void FreezerSlot :: renderItemInfo()
{
    if (is_EQUIPED == true)
