...
DroidSlot :: DroidSlot(Ship* _pTo_ship, TextureOb* _pTo_texOb, int _pos_x, int _pos_y)
{
     CommonForSlot_init(_pTo_ship, _pTo_texOb, _pos_x, _pos_y);
     type_id = DROID_SLOT_ID;
}

void DroidSlot :: insertDroidItem(DroidItem* pTo_item)
{
...
void DroidSlot :: removeDroidItem()
{
    item_subtype_id = -1;
...
void DroidSlot :: renderFrame(GLuint flash_tex)
{
...
void DroidSlot :: renderFrames(GLuint flash_tex)
{
