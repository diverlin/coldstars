...
const int* getArrayDependingOnClassTypeId(ENTITY::eTYPE class_type_id)
{
        switch(class_type_id)
        {
                case ENTITY::eTYPE::WARRIOR_ID:   { return SKILLS_STRATEGY_WARRIOR; break; }
                case ENTITY::eTYPE::PIRAT_ID:     { return SKILLS_STRATEGY_PIRAT; break; }
                case ENTITY::eTYPE::TRADER_ID:    { return SKILLS_STRATEGY_TRADER; break; }
                case ENTITY::eTYPE::DIPLOMAT_ID:  { return SKILLS_STRATEGY_DIPLOMAT; break; }
        }
...
const int* getArrayDependingOnRaceId(int race_id)
{
        switch(race_id)
        {
                case RACE::R0_ID: { return SKILLS_STRATEGY_RACE0; break; }
                case RACE::R1_ID: { return SKILLS_STRATEGY_RACE1; break; }
                case RACE::R2_ID: { return SKILLS_STRATEGY_RACE2; break; }
                case RACE::R3_ID: { return SKILLS_STRATEGY_RACE3; break; }
                case RACE::R4_ID: { return SKILLS_STRATEGY_RACE4; break; }
                case RACE::R6_ID: { return SKILLS_STRATEGY_RACE6; break; }
