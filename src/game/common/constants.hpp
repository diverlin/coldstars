...
const int OTSEC_SLOT_MAX_NUM = 18;
...
namespace SPECIAL_ACTION
{
	enum TYPE
	{
		INITIATE_DOCKING_ID=1, INITIATE_LAUNCHING_ID, INITIATE_JUMPIN_ID, INITIATE_JUMPOUT_ID
	};
}
...
namespace TEXTURE
{
	enum TEXTURE_TYPE
	{ 
		ANGAR_BACKGROUND_ID=1, STORE_BACKGROUND_ID, SHOP_BACKGROUND_ID, GOVERMENT_BACKGROUND_ID, 
