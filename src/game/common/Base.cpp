...
void Base::SaveDataUniqueBase(boost::property_tree::ptree& save_ptree, const std::string& root) const
{
	...
	save_ptree.put(root+"data_id.type_id",       (int)data_id.type_id);
	save_ptree.put(root+"data_id.subtype_id",    (int)data_id.subtype_id);
	save_ptree.put(root+"data_id.subsubtype_id", (int)data_id.subsubtype_id);
}
...
void Base::LoadDataUniqueBase(const boost::property_tree::ptree& load_ptree)
{
	...
	data_id.type_id         = (ENTITY::eTYPE)load_ptree.get<int>("data_id.type_id");
	data_id.subtype_id      = (ENTITY::eTYPE)load_ptree.get<int>("data_id.subtype_id");
	data_id.subsubtype_id   = (ENTITY::eTYPE)load_ptree.get<int>("data_id.subsubtype_id");
}
