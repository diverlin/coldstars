...
void GuiKosmoport::BindSharedGuis(GuiGalaxyMap* gui_galaxymap_shared, Vehicle* gui_vehicle_scan_shared, GuiSkills* gui_skills_shared, Slider* slider_shared)
{
    m_gui_galaxymap_shared    = gui_galaxymap_shared;
    m_gui_vehicle_scan_shared = gui_vehicle_scan_shared;
    m_gui_skills_shared       = gui_skills_shared;
    m_slider_shared           = slider_shared;
}
...
{      
    ...
    m_activeScreenId = GUI::SCREEN::ANGAR;
}
...
{     
    ...
    m_activeScreenId = GUI::SCREEN::SHOP;
}
...
{        
    ...
    m_activeScreenId = GUI::SCREEN::GOVERMENT;
}
