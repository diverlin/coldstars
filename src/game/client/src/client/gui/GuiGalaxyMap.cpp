...
int h = 300;
    ...
    setMaterial(new jeti::control::Material(MaterialCollector::get().text_background));
...
//            int font_size = 8;
//            glm::vec2 offset(0.0, 13.0);
//            client::shortcuts::screen()->DrawText(std::to_string(starsystem.id()), font_size, starsystem_pos + offset);
//        }
//    }
