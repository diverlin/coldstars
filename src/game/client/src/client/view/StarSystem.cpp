...
{
    jeti::animation::ConstantRotation* animation = new jeti::animation::ConstantRotation(axis, meti::rand::get_float(0.001, 0.01));
...
StarSystem::__createText()
{
    ...
    std::string str = std::to_string(meti::rand::get_int(1,200));
    float size = meti::rand::get_float(18.0f, 32.0f);
    glm::vec2 center(meti::rand::get_float(-10.0f,10.0f), meti::rand::get_float(-10.0f,10.0f));
    glm::vec4 color;
    color.r = meti::rand::get_float(0.7f, 1.0f);
    color.g = meti::rand::get_float(0.7f, 1.0f);
    color.b = meti::rand::get_float(0.7f, 1.0f);
...
StarSystem::__createExplosion()
{
    ...
    float size = meti::rand::get_float(1.0f, 10.0f);
    glm::vec3 center(meti::rand::get_float(-400.0f,400.0f), meti::rand::get_float(-400.0f,400.0f), 0.0f);
