...
{ 
        ...
        const glm::vec3& GetStartPos() const { return *pTo_start_pos; };
        const glm::vec3& GetEndPos() const { return *pTo_end_pos; };
     ...
     private:
               ...
               const glm::vec3* pTo_start_pos;
               const glm::vec3* pTo_end_pos;
