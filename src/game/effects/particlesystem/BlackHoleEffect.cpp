...
//{
	...
	////{
		...
		////texOb_particle = TextureManager::Instance().getParticleTexObByColorId(COLOR::RED_ID);
	...
	////{
		...
		////texOb_particle = TextureManager::Instance().getParticleTexObByColorId(COLOR::YELLOW_ID);
