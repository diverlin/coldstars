...
void load3DModels()
{        
    MeshCollector::Instance().RegisterMesh(new jeti::Mesh(TYPE::MESH::PLANE_ID,           DATA_PATH+"obj/plane/plane.obj",   glm::vec3(0.0f, 0.0f, 1.0f), nullptr));
    MeshCollector::Instance().RegisterMesh(new jeti::Mesh(TYPE::MESH::SPHERE_ID,          DATA_PATH+"obj/sphere/sphere.obj", glm::vec3(1.0f, 0.0f, 0.0f), nullptr));
    MeshCollector::Instance().RegisterMesh(new jeti::Mesh(TYPE::MESH::SPHERE_DEFORMED_ID, DATA_PATH+"obj/sphere_deformed/sphere_deformed.obj", glm::vec3(1.0f, 0.0f, 0.0f), nullptr));
    ...
    jeti::Mesh* mesh = new jeti::Mesh(TYPE::MESH::SPACESTATION_ID, DATA_PATH+"obj/vehicles/BabylonStation/babylon_station_mod.obj", glm::vec3(1.0f, 0.0f, 0.0f), textureOb);
//Mesh* mesh = new Mesh(TYPE::MESH::SPACESTATION_ID, DATA_PATH+"obj/sphere/sphere.obj", glm::vec3(1.0f, 0.0f, 0.0f), textureOb);    
    ...
    jeti::TextureOb* textureOb = new jeti::TextureOb(material_data);
    jeti::Mesh* mesh = new jeti::Mesh(TYPE::MESH::SPACESTATION_ID, DATA_PATH+"obj/vehicles/Anna_V_2.0_variations/anna_mod.obj", glm::vec3(1.0f, 0.0f, 0.0f), textureOb);
