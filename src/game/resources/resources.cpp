...
//{
    ...
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_3.png", true, &arg) );
//}
...
//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_5.png", true, &arg) );
//}

//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_6.png", true, &arg) );
//}

//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_7.png", true, &arg) );
//}

//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_8.png", true, &arg) );
//}

//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_9.png", true, &arg) );
//}

//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_10.png", true, &arg) );
//}

//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_11.png", true, &arg) );
//}

//{
    //std::vector<int> arg;   
    //arg.push_back((int)TYPE::RACE::R6_ID); arg.push_back((int)TYPE::ENTITY::WARRIOR_ID); //COLOR_GOLDENROD
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::SHIP_ID, DATA_PATH+"ship/k_61_0_12.png", true, &arg) );
//}
...
//{
    ...
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::LAZER_EFFECT_ID, DATA_PATH+"effect/lazer/l_64_26_000.png", true, &arg, 4, 1, 10) );
//}
...
//{
    //std::vector<int> arg;  
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::ROCKET_BULLET_ID, DATA_PATH+"bullet/t_0.png", true, &arg) );
//}

//{
    //std::vector<int> arg;  
    //TextureManager::Instance().Add( new TextureOb(TYPE::TEXTURE::ROCKET_BULLET_ID, DATA_PATH+"bullet/t_1.png", true, &arg) );
//}
