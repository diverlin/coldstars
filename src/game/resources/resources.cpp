...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R0_ID); arg.push_back((int)ENTITY::TYPE::RANGER_ID);   //COLOR_VIOLET
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_00_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R0_ID); arg.push_back((int)ENTITY::TYPE::WARRIOR_ID);  //COLOR_VIOLET
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_01_0_1.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R0_ID); arg.push_back((int)ENTITY::TYPE::PIRAT_ID);    //COLOR_VIOLET
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_02_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R0_ID); arg.push_back((int)ENTITY::TYPE::TRADER_ID);   //COLOR_VIOLET
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_03_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R0_ID); arg.push_back((int)ENTITY::TYPE::DIPLOMAT_ID); //COLOR_VIOLET
...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R1_ID); arg.push_back((int)ENTITY::TYPE::RANGER_ID);   //COLOR_GREY
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_10_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R1_ID); arg.push_back((int)ENTITY::TYPE::WARRIOR_ID);  //COLOR_GREY
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_11_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R1_ID); arg.push_back((int)ENTITY::TYPE::PIRAT_ID);    //COLOR_GREY
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_12_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R1_ID); arg.push_back((int)ENTITY::TYPE::TRADER_ID);   //COLOR_GREY
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_12_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R1_ID); arg.push_back((int)ENTITY::TYPE::DIPLOMAT_ID);  //COLOR_GREY
...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R3_ID); arg.push_back((int)ENTITY::TYPE::RANGER_ID); //COLOR_BLUE
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_30_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R3_ID); arg.push_back((int)ENTITY::TYPE::WARRIOR_ID); //COLOR_BLUE
...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R3_ID); arg.push_back((int)ENTITY::TYPE::PIRAT_ID);   //COLOR_BLUE
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_32_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R3_ID); arg.push_back((int)ENTITY::TYPE::TRADER_ID);  //COLOR_BLUE
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/_k_33_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R3_ID); arg.push_back((int)ENTITY::TYPE::DIPLOMAT_ID); //COLOR_BLUE
...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R4_ID); arg.push_back((int)ENTITY::TYPE::WARRIOR_ID); //COLOR_GOLDENROD
	TextureManager::Instance().Add( new TextureOb(TEXTURE::SHIP_ID, "data/ship/k_41_0_0.png", true, &arg) );
}

{
	std::vector<int> arg;   
	arg.push_back(RACE::R4_ID); arg.push_back((int)ENTITY::TYPE::TRADER_ID);  //COLOR_GOLDENROD
...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R4_ID); arg.push_back((int)ENTITY::TYPE::DIPLOMAT_ID); //COLOR_GOLDENROD
...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R6_ID); arg.push_back((int)ENTITY::TYPE::WARRIOR_ID); //COLOR_GOLDENROD
...
{
	std::vector<int> arg;   
	arg.push_back(RACE::R7_ID); arg.push_back((int)ENTITY::TYPE::WARRIOR_ID); //COLOR_GOLDENROD
