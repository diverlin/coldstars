...
{       
    for (int i=0; i<spacestation_per_system; i++) {
        ...
        control::SpaceStation* spacestation = core::SpaceStationBuilder::gen();
        core::VehicleBuilder::equip(spacestation);

        // npc_race_id, npc_group, npc_subgroup
        control::Npc* npc = core::NpcBuilder::gen();
...
void God::__createShips(control::StarSystem* starsystem, int ship_num, race::Type npc_race_id, entity::Type group, entity::Type subgroup) const
{
    ...
    for (int i=0; i<ship_num; i++)
    {
        ...
        core::control::Ship* new_ship = core::ShipBuilder::gen();
        core::ShipBuilder::equip(new_ship);

        // npc_race_id, npc_group, npc_subgroup
        core::control::Npc* new_npc = core::NpcBuilder::gen();
