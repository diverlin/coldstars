...
private:
    ...
    void __createShips(Starsystem*, int, race::type race_id = race::type::NONE_ID, entity::type subtype_id = entity::type::NONE_ID, entity::type subsubtype_id = entity::type::NONE_ID) const;
