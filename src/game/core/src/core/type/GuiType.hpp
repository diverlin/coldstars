...
{ 
    enum class Type
    {
        ...
        //WEAPON1_ACTIVATOR, WEAPON2_ACTIVATOR, WEAPON3_ACTIVATOR, WEAPON4_ACTIVATOR, WEAPON5_ACTIVATOR, WEAPON6_ACTIVATOR, WEAPON7_ACTIVATOR, WEAPON8_ACTIVATOR, WEAPON9_ACTIVATOR,
