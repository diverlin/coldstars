...
//    CREATE_PLAYER,
    ...
    PLAYER_REQUEST_CREATE_SHIP,
    PLAYER_REQUEST_BIND_NPC,
    PLAYER_REQUEST_INSERT_NPC_TO_SHIP,

    REPLY_PLAYER_CREATE_NPC,
    REPLY_PLAYER_CREATE_SHIP,
    REPLY_PLAYER_BIND_NPC,
    REPLY_PLAYER_INSERT_NPC_TO_SHIP
};
