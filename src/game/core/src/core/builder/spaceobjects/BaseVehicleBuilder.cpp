...
//    // GATE SLOT
//    {
//        ItemSlot* gate_slot = getNewItemSlot(entity::Type::GATE_SLOT_ID);
...
//    switch(type) {
//    case entity::Type::BAK_EQUIPMENT_ID:
//    {
...
//        break;
//    }
//    case entity::Type::DRIVE_EQUIPMENT_ID:
//    {
...
//        break;
//    }
//    case entity::Type::DROID_EQUIPMENT_ID:
//    {
//        DriveEquipment* bak_equipment = core::global::get().driveBuilder().create(descriptor);
//        if (vehicle->AddAndManageItem(drive_equipment) == false) {
//           core::global::get().entityManager().addToGarbage(drive_equipment);
...
//        if (vehicle->isSlotFree(entity::Type::WEAPON_SLOT_ID)) {
...
//    if (vehicle->isSlotFree(entity::Type::RADAR_SLOT_ID)) {
//        vehicle->manage(core::global::get().radarBuilder().getNew());
//    }
    
//    if (vehicle->isSlotFree(entity::Type::DRIVE_SLOT_ID)) {
//        vehicle->manage(core::global::get().driveBuilder().getNew());
//    }
    
//    if (vehicle->isSlotFree(entity::Type::BAK_SLOT_ID)) {
//        vehicle->manage(core::global::get().bakBuilder().getNew());
//    }

//#ifdef USE_EXTRA_EQUIPMENT
//    if (vehicle->isSlotFree(entity::Type::ENERGIZER_SLOT_ID)) {
//        vehicle->manage(core::global::get().energizerBuilder().getNew());
//    }
    
//    if (vehicle->isSlotFree(entity::Type::FREEZER_SLOT_ID)) {
//        vehicle->manage(core::global::get().freezerBuilder().getNew());
//    }
//#endif

//    if (vehicle->isSlotFree(entity::Type::PROTECTOR_SLOT_ID)) {
//        vehicle->manage(core::global::get().protectorBuilder().getNew());
//    }
        
//    if (vehicle->isSlotFree(entity::Type::DROID_SLOT_ID)) {
//        vehicle->manage(core::global::get().droidBuilder().getNew());
//    }
    
//    if (vehicle->isSlotFree(entity::Type::SCANER_SLOT_ID)) {
//        vehicle->manage(core::global::get().scanerBuilder().getNew());
//    }
    
//    if (vehicle->isSlotFree(entity::Type::GRAPPLE_SLOT_ID)) {
...
void BaseVehicleBuilder::EquipModules(Vehicle* vehicle, tech::type tech_level)
{
    ...
    {     
        ...
        switch(module_subtype_id) {
            case entity::Type::LAZER_MODULE_ID:       { vehicle->AddItemToCargoSlot(core::global::get().lazerModuleBuilder().create()); break; }
            case entity::Type::ROCKET_MODULE_ID:      { vehicle->AddItemToCargoSlot(core::global::get().rocketModuleBuilder().create()); break; }
            case entity::Type::DRIVE_MODULE_ID:       { vehicle->AddItemToCargoSlot(core::global::get().driveModuleBuilder().create()); break; }
            case entity::Type::RADAR_MODULE_ID:       { vehicle->AddItemToCargoSlot(core::global::get().radarModuleBuilder().create()); break; }
            case entity::Type::BAK_MODULE_ID:         { vehicle->AddItemToCargoSlot(core::global::get().bakModuleBuilder().create()); break; }
            //case entity::Type::ENERGIZER_MODULE_ID: { vehicle->AddItemToCargoSlot(core::global::get().energizerModuleBuilder().create()); break; }
            case entity::Type::PROTECTOR_MODULE_ID:   { vehicle->AddItemToCargoSlot(core::global::get().protectorModuleBuilder().create()); break; }
            case entity::Type::DROID_MODULE_ID:       { vehicle->AddItemToCargoSlot(core::global::get().droidModuleBuilder().create()); break; }
            //case entity::Type::FREEZER_MODULE_ID:   { vehicle->AddItemToCargoSlot(core::global::get().freezerModuleBuilder().create()); break; }
            case entity::Type::GRAPPLE_MODULE_ID:     { vehicle->AddItemToCargoSlot(core::global::get().grappleModuleBuilder().create()); break; }
            case entity::Type::SCANER_MODULE_ID:      { vehicle->AddItemToCargoSlot(core::global::get().scanerModuleBuilder().create()); break; }
        }
    }
}
#endif // USE_MODULES
