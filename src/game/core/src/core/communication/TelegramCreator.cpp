...
int_t TelegramCreator::__createPureGalaxy(int_t galaxy_descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(galaxy_descriptor_id, galaxy_id);
...
int_t TelegramCreator::__createPureSector(int_t sector_descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(sector_descriptor_id, sector_id);
...
int_t TelegramCreator::__createPureStarsystem(int_t starsystem_descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(starsystem_descriptor_id, starsystem_id);
...
int_t TelegramCreator::__createPureStar(int_t star_descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(star_descriptor_id, star_id);
...
int_t TelegramCreator::__createPurePlanet(int_t planet_descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(planet_descriptor_id, planet_id);
...
int_t TelegramCreator::__createPureShip(int_t descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(descriptor_id, ship_id);
...
int_t TelegramCreator::__createPureNpc(int_t descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(descriptor_id, npc_id);
...
void TelegramCreator::__addSectorToGalaxy(int_t sector_id, int_t galaxy_id) const
{
    ...
    descriptor::comm::AddPositionalComDescr telegram_descriptor(sector_id, galaxy_id, position);
...
void TelegramCreator::__addStarsystemToSector(int_t starsystem_id, int_t sector_id) const
{
    ...
    descriptor::comm::AddPositionalComDescr telegram_descriptor(starsystem_id, sector_id, position);
...
{
    meti::vec3 position;
    descriptor::comm::AddPositionalComDescr telegram_descriptor(star_id, starsystem_id, position);
...
{
    meti::vec3 position;
    descriptor::comm::AddPositionalComDescr telegram_descriptor(planet_id, starsystem_id, position);
...
{
    descriptor::comm::AddToStarsystemComDescr telegram_descriptor(ship_id, starsystem_id, center);
...
{
    descriptor::comm::ObjectSubjectComDescr telegram_descriptor(npc_id, ship_id);
...
int_t TelegramCreator::__createPureBak(int_t descriptor_id) const
{
    ...
    descriptor::comm::CreateComDescr telegram_descriptor(descriptor_id, item_id);
...
{
    descriptor::comm::ObjectSubjectComDescr telegram_descriptor(item_id, ship_id);
...
void TelegramCreator::createGalaxy(descriptor::GalaxyDescr* galaxy_descriptor) const
{
    // create galaxy
    ...
    for(int_t sector_descriptor_id: galaxy_descriptor->sectors) {
        ...
        // create starsystems
        descriptor::SectorDescr* sector_descriptor = core::shortcuts::descriptors()->sector(sector_descriptor_id);
...
void TelegramCreator::death(control::Asteroid* asteroid)
{
    ...
    for (int i=0; i<containers_num; ++i) {
        ...
        descriptor::comm::CreateGoodsPackComDescr telegram_descriptor(descriptor_id, item_id, amount);
        ...
        descriptor::comm::CreateContainerComDescr telegram_descriptor(descriptor_id, container_id, item_id);
        m_telegramHub.add(core::comm::ServerTelegram(telegram::Type::CREATE_CONTAINER, telegram_descriptor.data()));
        }
        {
        descriptor::comm::AddToStarsystemComDescr telegram_descriptor(container_id, asteroid->starsystem()->id(), asteroid->position(), impulses[i], asteroid->direction());
...
void TelegramCreator::__death(control::Vehicle* vehicle)
{
    ...
    for (int i=0; i<containers_num; ++i) {
        ...
        {
        descriptor::comm::AddToStarsystemComDescr telegram_descriptor(container_id, vehicle->starsystem()->id(), vehicle->position(), impulses[i], vehicle->direction()/* todo: add direction less way*/ );
        m_telegramHub.add(core::comm::ServerTelegram(telegram::Type::ADD_CONTAINER_TO_STARSYSTEM, telegram_descriptor.data()));
        }
    }
...
void TelegramCreator::genBullets_DEBUG(control::StarSystem* starsystem, int num) const
{
    ...
    descriptor::comm::CreateBulletComDescr telegram_descriptor(owner_id, item_id, target_id);
...
{
    descriptor::comm::ObjectSubjectComDescr descriptor(object->id(), object->starsystem()->id());
...
{
    descriptor::comm::ObjectDescr descriptor(object->id());
...
{
    descriptor::comm::effect::ExplosionEffectComDescr telegram_descriptor(radius, position);
...
{
    descriptor::comm::HitComDescr descriptor(object->id(), object->id(), damage);
...
{
    descriptor::comm::CreatePlayerComDescr descriptor(player_id, npc_id);
...
{
    descriptor::comm::ObjectSubjectComDescr descriptor(vehicle_id, target_id);
