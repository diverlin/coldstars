...
TEST(starsystem, add_remove_wormhole)
{
    ...
    int iterations = 5;
    for(int i=1; i<iterations; ++i) {
        core::control::WormHole* wormhole = GovermentBuilder::WormHoleBuilder::gen();
...
TEST(starsystem, add_remove_spacestation)
{
    ...
    int iterations = 5;
    for(int i=1; i<iterations; ++i) {
        core::control::SpaceStation* spacestation = GovermentBuilder::SpaceStationBuilder::gen();
...
TEST(starsystem, add_remove_satellite)
{
    ...
    int iterations = 5;
    for(int i=1; i<iterations; ++i) {
        core::control::Satellite* satellite = GovermentBuilder::SatelliteBuilder::gen();
...
TEST(starsystem, add_remove_bullet)
{
    ...
    int iterations = 5;
    for(int i=1; i<iterations; ++i) {
        core::control::Bullet* bullet = GovermentBuilder::BulletBuilder::gen(1);
