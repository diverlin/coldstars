...
TEST(core, clone_radar) {
    core::RadarDescr* descr = core::genRadar();
    core::RadarDescr* copy = new core::RadarDescr(descr->data());

    EXPECT_EQ(descr->type(), core::Type::RADAR_EQUIPMENT);
