...
TEST(communication, create_starsystem)
{
    ...
    core::global::get().telegrammManager().add(core::comm::Telegramm(core::comm::Telegramm::Type::CREATE_STARSYSTEM, creation.data()));
...
TEST(communication, create_ship)
{
    ...
    core::global::get().telegrammManager().add(core::comm::Telegramm(core::comm::Telegramm::Type::CREATE_SHIP, creation.data()));
...
TEST(communication, create_bak)
{
    ...
    core::global::get().telegrammManager().add(core::comm::Telegramm(core::comm::Telegramm::Type::CREATE_BAK, creation.data()));
