...
{    
    Logger::Instance().Log("npc_id=" + std::to_string(npc->id()) + " ENTER MicroScenarioExploration");
}
...
{
    Logger::Instance().Log("npc_id=" + std::to_string(npc->id()) + " EXIT MicroScenarioExploration");
}
