...
void BaseVehicleBuilder::equip(Vehicle* vehicle, TYPE::TECH tech_level) const
{
    ...
    if (vehicle->isSlotExists(TYPE::ENTITY::RADAR_SLOT_ID)) {
        auto descr = global::get().descriptorManager().getRandom(descriptor::Type::RADAR);
    ...
    if (vehicle->isSlotExists(TYPE::ENTITY::DRIVE_SLOT_ID)) {
        auto descr = global::get().descriptorManager().getRandom(descriptor::Type::DRIVE);
    ...
    if (vehicle->isSlotExists(TYPE::ENTITY::BAK_SLOT_ID)) {
        auto descr = global::get().descriptorManager().getRandom(descriptor::Type::BAK);
    ...
    if (vehicle->isSlotExists(TYPE::ENTITY::PROTECTOR_SLOT_ID)) {
        auto descr = global::get().descriptorManager().getRandom(descriptor::Type::PROTECTOR);
    ...
    if (vehicle->isSlotExists(TYPE::ENTITY::DROID_SLOT_ID)) {
        auto descr = global::get().descriptorManager().getRandom(descriptor::Type::DROID);
    ...
    if (vehicle->isSlotExists(TYPE::ENTITY::SCANER_SLOT_ID)) {
        auto descr = global::get().descriptorManager().getRandom(descriptor::Type::SCANER);
    ...
    if (vehicle->isSlotExists(TYPE::ENTITY::GRAPPLE_SLOT_ID)) {
        auto descr = global::get().descriptorManager().getRandom(descriptor::Type::GRAPPLE);
