...
//    Logger::Instance().Log("___::~Orientation("+std::to_string(GetId())+")");
//    #endif
}
...
//    Logger::Instance().Log(" Orientation("+std::to_string(GetId())+")::SaveDataUniqueOrientation", SAVELOAD_LOG_DIP);
//    #endif
...
{
//    #if SAVELOAD_LOG_ENABLED == 1
//    Logger::Instance().Log(" Orientation("+std::to_string(GetId())+")::LoadDataUniqueOrientation", SAVELOAD_LOG_DIP);
//    #endif
...
{
//    #if SAVELOAD_LOG_ENABLED == 1
//    Logger::Instance().Log(" Orientation("+std::to_string(GetId())+")::ResolveDataUniqueOrientation", SAVELOAD_LOG_DIP);
//    #endif
}
