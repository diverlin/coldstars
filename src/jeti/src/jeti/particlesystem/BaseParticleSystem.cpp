...
Particle* Base::_genParticle() const
{
    ...
    if (m_config.use_rand_color_delta) {
        ...
        delta_color.r = meti::rand::add_percent(m_config.particle.color_delta.r, m_config.rand_color_delta);
        delta_color.g = meti::rand::add_percent(m_config.particle.color_delta.g, m_config.rand_color_delta);
        delta_color.b = meti::rand::add_percent(m_config.particle.color_delta.b, m_config.rand_color_delta);
        delta_color.a = meti::rand::add_percent(m_config.particle.color_delta.a, m_config.rand_color_delta);
        particle->setColorDelta(delta_color);
    }
    if (m_config.use_rand_size_delta) {
        float size_delta = meti::rand::add_percent(m_config.particle.size_delta, m_config.rand_size_delta);
