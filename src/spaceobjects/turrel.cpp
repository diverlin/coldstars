...
bool Turrel :: isAmmoOk() const
{
	...
	{
    		case EQUIPMENT::LAZER:  { /*if check energy */  return true; break; }
    		case EQUIPMENT::ROCKET: { if (slot->getRocketEquipment()->getAmmo() > 0) return true; break; }
	}
