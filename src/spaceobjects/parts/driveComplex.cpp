...
DriveComplex :: DriveComplex(VehicleBase* owner_vehicle)
{      
...
bool DriveComplex :: getDockingPermission()
{
	switch(target->getTypeId())
	{
		case PLANET_ID:   { return ((Planet*)target)->getDockingStation()->getPermissionToLand(); break; }
		case STARBASE_ID: { return ((StarBase*)target)->getDockingStation()->getPermissionToLand(); break; }
