...
class FreezerItem : public CommonForItems
{  
   public:
      int type_id;
      int subtype_id;
      ...
      FreezerItem();
      FreezerItem(TextureOb* _pTo_itemTexOb, int _freeze_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
      ~FreezerItem();
