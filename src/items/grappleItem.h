...
#ifndef GRAPPLEITEM_H
#define GRAPPLEITEM_H


class GrappleItem : public CommonForItems
{
   public:
      int type_id;
      int subtype_id;
      ...
      GrappleItem();
      GrappleItem(TextureOb* _pTo_itemTexOb, int _strength_orig, int _radius_orig, int _speed_orig, int _maxNumItem_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);   // joun strength and speed attributes into one
      ~GrappleItem();
