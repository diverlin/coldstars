...
class RadarItem : public CommonForItems
{
   public:
      int type_id;
      int subtype_id;
      ...
      RadarItem();
      RadarItem(TextureOb* pTo_itemTexOb, int _radius_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
      ~RadarItem();
