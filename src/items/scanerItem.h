...
class ScanerItem : public CommonForItems
{
  public:
    int type_id;
    int subtype_id;
    ...
    ScanerItem();
    ScanerItem(TextureOb* _pTo_itemTexOb, int _scan_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
    ~ScanerItem();
