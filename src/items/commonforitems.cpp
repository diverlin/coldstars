...
#include "commonforitems.h"


CommonForItems :: CommonForItems()
{}

void CommonForItems :: CommonForItems_init(TextureOb* _pTo_itemTexOb, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate)
{
    pTo_itemTexOb = _pTo_itemTexOb;

    if (pTo_itemTexOb->is_animated == false)
       pToFunc_render = &CommonForItems::_renderFrame;
    else
       pToFunc_render = &CommonForItems::_renderFrames;
...
void CommonForItems :: deterioration()
{
...
void CommonForItems :: render(Rect slot_rect)
{
     (this->*pToFunc_render)(slot_rect);
}


void CommonForItems :: _renderFrame(Rect slot_rect)
{
...
void CommonForItems :: _renderFrames(Rect slot_rect)
{
...
void CommonForItems :: renderInfo(Rect slot_rect)
{  
