...
#ifndef COMMONFORITEMS_H
#define COMMONFORITEMS_H


class CommonForItems
{
   public:
     ...
     CommonForItems();
     void CommonForItems_init(TextureOb* _pTo_itemTexOb, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
     void deterioration();
     void repair();

     void render(Rect slot_rect);
          void (CommonForItems::*pToFunc_render)(Rect slot_rect);
