...
class LazerItem : public CommonForItems
{
    public:
      int type_id;
      int subtype_id;
      ...
      LazerItem(TextureOb* _pTo_itemTexOb, int _damage_orig, int _radius_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
      ~LazerItem();
