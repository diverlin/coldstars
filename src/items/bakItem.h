...
class BakItem : public CommonForItems
{
public:
     int type_id;
     int subtype_id;
     ...
     BakItem();
     BakItem(TextureOb* _pTo_itemTexOb, int _fuel_max_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
     ~BakItem();
