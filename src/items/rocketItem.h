...
class RocketItem : public CommonForItems
{ 
   public:
      int type_id;
      int subtype_id;
      ...
      RocketItem();
      RocketItem(TextureOb* pTo_itemTexOb, int _ammo_max_orig, int _damage_orig, int _radius_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
      ~RocketItem();
