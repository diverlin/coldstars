...
#ifndef ENERGIZERITEM_H
#define ENERGIZERITEM_H


class EnergizerItem : public CommonForItems
{
public:
      int type_id;
      int subtype_id;
      ...
      EnergizerItem();
      EnergizerItem(TextureOb* _pTo_itemTexOb, int _energy_max_orig, int _restoration_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate);
      ~EnergizerItem();
