...
RadarEquipment :: RadarEquipment(TextureOb* _pTo_itemTexOb, int _radius_orig, int _modules_num_max, int _mass, int _condition_max, int _deterioration_rate)
{
...
RadarEquipment* radarEquipmentGenerator(int race_id, int revision_id)
{
    ...
    RadarEquipment* pTo_radar = new RadarEquipment(pTo_itemTexOb, radius_orig, modules_num_max, mass, condition_max, deterioration_rate);
    return pTo_radar;
}
