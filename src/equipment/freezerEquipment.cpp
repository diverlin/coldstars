...
{
    	CommonForEquipment_init(FREEZER_ID, _pTo_itemTexOb, _modules_num_max, _mass, _condition_max, _deterioration_rate);
...
FreezerEquipment* freezerEquipmentGenerator(int race_id, int revision_id)
{
    	...
    	FreezerEquipment* _freezer_module = new FreezerEquipment(pTo_itemTexOb,  freeze_orig, modules_num_max, mass, condition_max, deterioration_rate);
