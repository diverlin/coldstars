...
DroidEquipment :: DroidEquipment(TextureOb* _pTo_itemTexOb, 
				 int _repair_orig, 
...
{
    	CommonForEquipment_init(DROID_ID, _pTo_itemTexOb, _modules_num_max, _mass, _condition_max, _deterioration_rate);
...
DroidEquipment* droidEquipmentGenerator(int race_id, int revision_id)
{
    	...
    	DroidEquipment* _droid = new DroidEquipment(pTo_itemTexOb, repair_orig, modules_num_max, mass, condition_max, deterioration_rate);
    	return _droid;
}
